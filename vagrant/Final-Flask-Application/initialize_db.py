...
from myapp.models import Restaurant, Base, MenuItem, User
...
def add():
    ...
    menuItem2 = MenuItem(user_id=1, name="Peking Duck",
                ...
                the skin and little meat, sliced in front of the diners \
                by the cook",
    ...
    menuItem5 = MenuItem(user_id=1, name="Beef Noodle Soup",
                ...
                braised beef, beef broth, vegetables and Chinese noodles",
    ...
    menuItem6 = MenuItem(user_id=1, name="Ramen",
                ...
                (occasionally) fish-based broth, often flavored with soy \
                sauce or miso, and uses toppings such as sliced pork, \
    ...
    menuItem3 = MenuItem(user_id=1, name="Potstickers",
                         description="Delicious chicken and veggies encapsulated in \
                fried dough.",
    ...
    menuItem3 = MenuItem(user_id=1, name="Morels on toast (seasonal)",
                         description="Wild morel mushrooms fried in butter, served \
                on herbed toast slices",
    ...
    menuItem1 = MenuItem(user_id=1, name="Lemon Curd Ice Cream Sandwich",
                ...
                macaron with cardamom meringue and cashews",
